...
import in.nabin.springsecurity.repo.RoleRepo;
import in.nabin.springsecurity.repo.UserRepo;
...
public class UserServiceImpl implements UserService , UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(user==null) {
            log.error("USer not foound in the database");
...
//  Get particular role from the username argument
    @Override
